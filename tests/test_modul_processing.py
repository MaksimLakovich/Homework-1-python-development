...
@pytest.mark.parametrize("transaction_state, expected_fixture",
                         [
...
@pytest.mark.parametrize("sort_parameter, expected_fixture",
                         [
                             (True, "sorted_with_reverse"),
                             (False, "sorted_without_reverse")
                         ])
